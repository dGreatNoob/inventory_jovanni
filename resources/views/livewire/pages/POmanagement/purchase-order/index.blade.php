...
<div class="">
    <div class="">
                    ...
                    <tbody>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                <a href="{{ route('pomanagement.purchaseorder.qr', ['Id' => $po->id]) }}" target="_blank">
                                    <img 
                                        src="https://api.qrserver.com/v1/create-qr-code/?size=128x128&data={{ urlencode(route('pomanagement.purchaseorder.qr', ['Id' => $po->id])) }}"
                                        class="inline-block w-16 h-16 mr-2 hover:scale-105 transition cursor-pointer"
                                    />
                                </a>
                            </td>
                            <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
        ...
        <section>
            @livewire('pages.POManagement.purchase-order.analytics')
        </section>
        @endif
        ...
        <section>
            <!-- Delete Modal -->
            @if ($showDeleteModal)
                <div class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full flex items-center justify-center bg-transparent">
                                ...
                                <div class="relative overflow-x-auto">
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="4" class="px-4 py-3 text-center">No approval logs found</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
