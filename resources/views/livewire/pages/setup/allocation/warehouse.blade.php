<x-slot:header>Warehouse Allocations</x-slot:header>
<x-slot:subheader>Warehouse Allocation Management</x-slot:subheader>
<div class="">
    <div class="">
    ...
    <div class="mb-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-amber-700 dark:text-amber-300">
                    <p>The Setup Management Allocation module is currently under revision and may not be fully functional. Some features may be incomplete or unavailable. Please use the Product Management module for core inventory operations.</p>
                </div>
            </div>
        </div>
    </div>
        <x-collapsible-card title="Create Warehouse Allocation" open="false" size="full">
            <form wire:submit.prevent="create" x-show="open" x-transition>
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <x-input type="text" wire:model="name" name="name" label="Warehouse Allocation Name" placeholder="Enter warehouse allocation name" />
                    </div>
                    <div>
        ...
        <x-collapsible-card title="Warehouse Allocations List" open="true" size="full">
            <div class="flex items-center justify-between p-4 pr-10">
                <div class="flex space-x-6">
                    <div class="relative">
                        <x-input type="text" wire:model.live="search" name="search" label="Search" placeholder="Search warehouse allocations..." />
                    </div>
                </div>
            </div>
                ...
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this warehouse allocation?</h3>
