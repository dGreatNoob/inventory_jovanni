            ...
            <div x-show="open" x-transition>
                <form wire:submit.prevent="create">
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <x-dropdown wire:model="branch_id" name="branch_id" label="Branch" :options="$branches->pluck('name', 'id')" placeholder="Select Branch" />
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">{{ $profile->branch->name }}</td>
                        ...
                        <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                            <form wire:submit.prevent="update">
                                <div class="grid gap-6 mb-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        <x-dropdown wire:model="branch_id" name="branch_id" label="Branch" :options="$branches->pluck('name', 'id')" />
                                        @error('branch_id') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    </div>
                                    <div>
