{{-- <div class="flex aspect-square size-8 items-center justify-center rounded-md bg-accent-content text-accent-foreground">
    <x-app-logo-icon class="size-5 fill-current text-white dark:text-wh" />
</div> --}}
<div class="flex items-center">
    <div class="flex h-12 w-16 items-center justify-center rounded-md text-accent-foreground">
