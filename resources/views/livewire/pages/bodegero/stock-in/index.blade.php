        ...
        <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-zinc-700">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 dark:border-zinc-600 rounded-xl p-4 space-y-3">
                    ...
                    @if($supplyOrder->supplyProfile->supply_item_class === 'consumable')
                    <div class="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                        <div class="flex items-center gap-2 mb-3">
                            <svg class="w-4 h-4 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                            </svg>
                            <h5 class="text-xs font-bold text-amber-800 dark:text-amber-200">Batch Information (Required for Consumables)</h5>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2">
                                <div class="flex-1">
                                    <label for="batch-{{ $supplyOrder->id }}" class="text-xs font-medium text-amber-700 dark:text-amber-300">Batch Number:</label>
                                    <input 
                                        type="text"
                                        id="batch-{{ $supplyOrder->id }}"
                                        wire:model="itemBatchNumbers.{{ $supplyOrder->id }}"
                                ...
                                <button 
                                    type="button"
                                    wire:click="generateNewBatchNumber({{ $supplyOrder->id }})"
                                    class="px-2 py-1 text-xs font-medium text-amber-700 bg-amber-100 border border-amber-300 rounded hover:bg-amber-200 focus:ring-2 focus:ring-amber-500 dark:bg-amber-800 dark:text-amber-200 dark:border-amber-700 dark:hover:bg-amber-700">
                                    Generate
                                </button>
                            </div>
                            ...
                            <!-- Batch Notes -->
                            <div>
                                <label for="batch-notes-{{ $supplyOrder->id }}" class="text-xs font-medium text-amber-700 dark:text-amber-300">Batch Notes:</label>
                                <textarea 
                                    id="batch-notes-{{ $supplyOrder->id }}"
                                    wire:model="itemBatchNotes.{{ $supplyOrder->id }}"
                                    rows="2"
                                    class="w-full px-2 py-1 text-xs border border-amber-300 rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-amber-900/30 dark:border-amber-700 dark:text-amber-100 dark:focus:ring-amber-400 dark:focus:border-amber-400"
                                    placeholder="Special notes about this batch..."></textarea>
                            </div>
                        </div>
                    </div>
                    @endif
