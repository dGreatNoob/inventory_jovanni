    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <select wire:model.live="selectedSupplier" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-gray-500 focus:border-gray-500 dark:focus:ring-gray-400 dark:focus:border-gray-400 sm:text-sm rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white">
