...
<div class="space-y-6">
    <!-- Filters -->
    <div class="p-4 bg-gray-50 rounded-lg dark:bg-gray-800/50 grid gap-4 md:grid-cols-3">
        <div>
        ...
        <div>
            ...
            <select id="selectedBranch" wire:model.live="selectedBranch" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
